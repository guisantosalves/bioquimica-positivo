...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            user.setSexo(faker.demographic().sex());
        ...
        for (int i = 0; i < 5; i++) {
            ...
            paciente.setSexo(faker.demographic().sex());
        ...
        if (!pacientesList.isEmpty() && !exameSchemaList.isEmpty()) {
            for (int i = 0; i < 10; i++) {
                ...
                ExameSchema randomSchema = exameSchemaList.get(faker.random().nextInt(exameSchemaList.size()));
                ...
                Exame exame = new Exame(
                        ...
                        randomSchema.getId(),
                        convertToLocalDateTime(faker.date().past(365, TimeUnit.DAYS)), // Data do exame no último ano
                        dadosPreenchidos,
            ...
            System.out.println("Não é possível criar exames: não há pacientes ou schemas de exame cadastrados.");
        }
